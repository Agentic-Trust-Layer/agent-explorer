...
export const DEFAULT_TRUST_LEDGER_BADGES: TrustLedgerBadgeDefinition[] = [
  ...
  {
    badgeId: 'feedback:ten',
    program: TRUST_LEDGER_PROGRAM,
    name: 'Ten Reviews',
    description: 'Agent received at least 10 feedback entries.',
    iconRef: 'badge:feedback:ten',
    points: 20,
    ruleId: 'feedback_count_gte',
  ...
  {
    badgeId: 'registration:present',
    program: TRUST_LEDGER_PROGRAM,
    name: 'Registration Present',
    description: 'Agent has ERC-8004 registration JSON materialized in the KB.',
    iconRef: 'badge:registration:present',
    points: 5,
    ruleId: 'registration_json_present',
    ruleConfig: { threshold: 1 },
    active: true,
  },
  {
    badgeId: 'wallet:present',
    program: TRUST_LEDGER_PROGRAM,
    name: 'Wallet Set',
    description: 'Agent has a wallet account recorded on its ERC-8004 identity.',
    iconRef: 'badge:wallet:present',
    points: 5,
    ruleId: 'wallet_account_present',
    ruleConfig: { threshold: 1 },
    active: true,
  },
  {
  ...
  {
    badgeId: 'mcp:active_endpoint',
    program: TRUST_LEDGER_PROGRAM,
    name: 'MCP Endpoint Active',
    description: 'Agent has a live MCP endpoint check marked alive in the KB.',
    iconRef: 'badge:mcp:active_endpoint',
    points: 15,
    ruleId: 'mcp_alive_present',
    ruleConfig: { threshold: 1 },
    active: true,
  },
  {
