...
export async function kbHydrateAgentsByDid8004(
  ...
  const sparql = [
    ...
    '    OPTIONAL { ?agent core:hasDescriptor ?agentDesc . ?agentDesc dcterms:title ?agentName }',
    ...
    '        OPTIONAL { ?pA2a core:hasDescriptor ?pA2aDesc . OPTIONAL { ?pA2aDesc core:agentCardJson ?a2aJson } }',
    ...
    '        OPTIONAL { ?pMcp core:hasDescriptor ?pMcpDesc . OPTIONAL { ?pMcpDesc core:agentCardJson ?mcpJson } }',
