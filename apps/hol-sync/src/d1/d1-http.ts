...
export function getD1ConfigFromEnv(): D1Config | null {
  ...
  const databaseId = envString('HOL_INDEXER_D1_DATABASE_ID') || envString('CLOUDFLARE_D1_DATABASE_ID');
...
async function d1FetchJson(config: D1Config, body: any, opts?: { timeoutMs?: number; retries?: number }): Promise<any> {
