...
- **Relationship**: `agentictrust:Relationship` (persistent relationship instance)
  ...
  - Specialized as `erc8092:ERC8092Relationship` and `erc8092:ERC8092AccountRelationship` (equivalent classes)
- **RelationshipAssertion**: `agentictrust:RelationshipAssertion` (constitutive assertion)
  - Specialized as `erc8092:ERC8092RelationshipAssertion` and `erc8092:ERC8092AccountRelationshipAssertion` (equivalent classes)
...
class ERC8092AccountRelationship["erc8092:ERC8092AccountRelationship"]
class ERC8092RelationshipAssertion["erc8092:ERC8092RelationshipAssertion"]
class ERC8092AccountRelationshipAssertion["erc8092:ERC8092AccountRelationshipAssertion"]
