...
`erc8004:AgentRegistration8004` is an ERC-8004 agent registration descriptor that extends `agentictrust:AgentDescriptor`. It contains all agent registration data extracted from tokenUri rawJson metadata, including:
...
AIAgent --> AgentRegistration8004 : hasAgentRegistration8004
